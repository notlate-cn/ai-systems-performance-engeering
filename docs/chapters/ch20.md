...
![图20-1 使用强化学习为您的环境找到最优的GPU内核代码](../assets/images/ch20/fig20_1376_1.png)
...
![图20-3 在NVIDIA Hopper平台上使用DeepSeek-R1进行推理时扩展（来源：Automating GPU Kernel Generation with DeepSeek-R1 and Inference Time Scaling | NVIDIA Technical Blog）](../assets/images/ch20/fig20_1381_1.png)
...
![图20-4 自动生成的注意力内核相比PyTorch FlexAttention实现了1.1x-2.1x加速（来源：Automating GPU Kernel Generation with DeepSeek-R1 and Inference Time Scaling | NVIDIA Technical Blog）](../assets/images/ch20/fig20_1383_1.png)
...
![图20-5 为生成正确和高性能的OpenAI Triton代码分配基于RL的奖励（相对于基线）（来源：https://oreil.ly/JBxdW）](../assets/images/ch20/fig20_1386_1.png)
...
![图20-7 CUDA中的图执行减少了按顺序启动多个内核时的开销（来源：https://oreil.ly/kxSDm）](../assets/images/ch20/fig20_1393_1.png)
...
![图20-8 AI助手监视长时间运行的训练作业并建议修复异常的操作](../assets/images/ch20/fig20_1398_1.png)
