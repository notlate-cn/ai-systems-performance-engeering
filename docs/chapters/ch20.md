...
![图20-2 Strassen用于乘法2×2矩阵的次二次算法（来源：https://oreil.ly/5jzLn）](../assets/images/ch20/fig20_1378_1.png)
...
![图20-4 自动生成的注意力内核相比PyTorch FlexAttention实现了1.1×–2.1×加速（来源：Automating GPU Kernel Generation with DeepSeek-R1 and Inference Time Scaling | NVIDIA Technical Blog）](../assets/images/ch20/fig20_1383_1.png)
