...
![Figure 2-1. NVIDIA Grace Blackwell Superchip module containing one Grace CPU (center) and two Blackwell B200 GPUs (top left and right) on a single module with a shared unified memory space and connected by a custom high-speed link called NVLink-C2C (chip-to-chip)](../assets/images/ch02/fig2_47_1.png)
*图2-1 NVIDIA Grace Blackwell超级芯片模块，包含一个Grace CPU（中心）和两个Blackwell B200 GPU（左上和右上），具有共享的统一内存空间，通过称为NVLink-C2C（芯片到芯片）的定制高速链路连接*
...
![Figure 2-2. Blackwell dual-die multichip module (MCM) design](../assets/images/ch02/fig2_52_1.png)
*图2-2 Blackwell双裸片多芯片模块（MCM）设计*
...
## NVIDIA GPU Tensor Core和Transformer Engine
...
![Figure 2-3. Relative speedup of FP8 and FP4 compared to FP16](../assets/images/ch02/fig2_56_1.png)
*图2-3 FP8和FP4相对于FP16的加速比*
...
![Figure 2-4. Comparing CPU cores to GPU cores](../assets/images/ch02/fig2_59_1.png)
*图2-4 比较CPU核心与GPU核心*
...
![Figure 2-5. GPU memory hierarchy](../assets/images/ch02/fig2_61_1.png)
*图2-5 GPU内存层次结构*
...
![Figure 2-6. A 1U compute tray within the GB200/GB300 NVL72 rack with two Grace Blackwell Superchips](../assets/images/ch02/fig2_63_1.png)
*图2-6 GB200/GB300 NVL72机柜内的1U计算托盘，包含两个Grace Blackwell超级芯片*
...
![Figure 2-7. One NVLink Switch tray inside the NVL72](../assets/images/ch02/fig2_66_1.png)
*图2-7 NVL72内部的一个NVLink交换托盘*
...
![Figure 2-8. NVSwitch System of nine trays inside an NVL72 rack](../assets/images/ch02/fig2_68_1.png)
*图2-8 NVL72机柜内的九个托盘NVSwitch系统*
...
![Figure 2-9. Each GPU connects to each NVSwitch (one link for each switch)](../assets/images/ch02/fig2_70_1.png)
*图2-9 每个GPU连接到每个NVSwitch（每个交换机一个链路）*
...
![Figure 2-10. Offloading computations to the NVIDIA network hardware using SHARP reduction engines in NVSwitch](../assets/images/ch02/fig2_74_1.png)
*图2-10 使用NVSwitch中的SHARP归约引擎将计算卸载到NVIDIA网络硬件*
...
### Blackwell Ultra和Grace Blackwell Ultra
